...
5.  I then created a new data frame `gbb_df` that joined together the 3 data sets using the `left_join` function.
6.  I used `tidyverse` and the `pipe` function to achieve this data wrangling.
...
results_df = 
  ...
  janitor::clean_names() |>
  select(c(baker, technical, result, episode))
